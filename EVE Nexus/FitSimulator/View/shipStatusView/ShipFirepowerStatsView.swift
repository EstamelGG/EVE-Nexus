...
struct ShipFirepowerStatsView: View {
    ...
    struct WeaponDPSResult {
        ...
        // 伤害类型占比 - 使用DPS而不是原始伤害计算
        var emRatio: Double {
            return dpsWithoutReload > 0 ? emDPS / dpsWithoutReload : 0
        }
        
        var explosiveRatio: Double {
            return dpsWithoutReload > 0 ? explosiveDPS / dpsWithoutReload : 0
        }
        
        var kineticRatio: Double {
            return dpsWithoutReload > 0 ? kineticDPS / dpsWithoutReload : 0
        }
        
        var thermalRatio: Double {
            return dpsWithoutReload > 0 ? thermalDPS / dpsWithoutReload : 0
        }
    }
    ...
    struct DroneDPSResult {
        ...
        // 伤害类型占比
        var emRatio: Double {
            return dps > 0 ? emDPS / dps : 0
        }
        
        var explosiveRatio: Double {
            return dps > 0 ? explosiveDPS / dps : 0
        }
        
        var kineticRatio: Double {
            return dps > 0 ? kineticDPS / dps : 0
        }
        
        var thermalRatio: Double {
            return dps > 0 ? thermalDPS / dps : 0
        }
    }
