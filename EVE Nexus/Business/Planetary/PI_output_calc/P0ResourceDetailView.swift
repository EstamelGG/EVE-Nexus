...
struct P0ResourceDetailView: View {
    ...
    let systemIds: [Int]
    @State private var systemPlanets: [(systemId: Int, systemName: String, security: Double, planets: [(type: Int, count: Int, iconFileName: String, typeName: String)])] = []
    ...
    private func loadSystemPlanets() {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            var loadedSystemPlanets: [(systemId: Int, systemName: String, security: Double, planets: [(type: Int, count: Int, iconFileName: String, typeName: String)])] = []
            ...
            if case let .success(rows) = DatabaseManager.shared.executeQuery(query) {
                ...
                for row in rows {
                    ...
                    var planetCounts: [(type: Int, count: Int, iconFileName: String, typeName: String)] = []
