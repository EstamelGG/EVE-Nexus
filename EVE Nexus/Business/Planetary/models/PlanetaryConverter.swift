...
class PlanetaryConverter {
        ...
        if let pinContents = planetaryPin.contents {
            for content in pinContents {
                ...
                let contentType = Type(
                    id: content.typeId, name: contentTypeInfo.name, volume: contentTypeInfo.volume
                )
        ...
        case 1063: // 采集控制器/提取器组
            ...
            if let extractorDetails = planetaryPin.extractorDetails {
                ...
                return Pin.Extractor(
                    ...
                    cycleTime: cycleTime,
                    headRadius: extractorDetails.headRadius != nil
                        ? Double(extractorDetails.headRadius!) : nil,
                    heads: heads,
    ...
    private static func convertRoute(_ planetaryRoute: PlanetaryRoute) -> Route {
        ...
        let type = Type(
            id: planetaryRoute.contentTypeId, name: typeInfo.name, volume: typeInfo.volume
        )
