    ...
    func search() async {
        do {
            ...
            if let characters = searchResponse.character {
                ...
                let corporationNamesWithCategories = try await UniverseAPI.shared.getNamesWithFallback(ids: Array(corpIds))
                ...
                if !allianceIds.isEmpty {
                    ...
                    let allianceNamesWithCategories = try await UniverseAPI.shared.getNamesWithFallback(ids: Array(allianceIds))
